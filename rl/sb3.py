...
# https://youtu.be/OqvXHi_QtT0?si=8dD5ULuKjPAp-5E4
# python sb3-py Humanoid-v4 A2C -s •/models/A2C_125000.zip
...
model_dir = "/media/psf/Home/Desktop/model-a-day/rl/sb3_models"
log_dir = "/media/psf/Home/Desktop/model-a-day/logs"
...
def train(env, sb3_algo):
    ...
    while True:
        ...
        try:
            ...
            print(f"Model saved to {model_dir}/{sb3_algo}_{TIMESTEPS*iters}")
