...
def run(is_training=True, render=False):
    ...
    if is_training:
        ...
        # Ensure this file path and name match where and how you've saved your Q-table
        with open('/Users/williamphan/Desktop/model-a-day/rl/envs/cartpole.pkl', 'rb') as f:
            q = pickle.load(f)
            f.close()
    ...
    if is_training:
        f = open('/Users/williamphan/Desktop/model-a-day/rl/envs/cartpole.pkl','wb')
        pickle.dump(q, f)
        f.close()
    ...
    plt.savefig(f'rl/envs/cartpole.png')
